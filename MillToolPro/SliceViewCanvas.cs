	...
	class SliceViewCanvas : PanZoomCanvas2D
	{
        ...
        public int CurrentLayer {
			...
			set {
				...
				Interval1d layer_zrange = Layers.GetLayerZInterval(currentLayer, false);
				Interval1d prev_zrange = Layers.GetLayerZInterval(currentLayer - 1, false);
				LayerFilterF = (v) => {
        ...
        private void DrawLayerInfo(SKCanvas canvas, SKPaint paint)
        {
            ...
            string text = "Layer " + currentLayer.ToString() + " - Z " + Math.Round(Layers.GetLayerZ(currentLayer), 4);
            paint.Color = SKColors.Black;
            paint.StrokeWidth = 1;
        ...
        public List<PolyLine2d> GetPolylinesForLayer(int layer)
        {
            ...
            SKColor extrudeColor = SkiaUtil.Color(0, 0, 0, 255);
            Interval1d layer_zrange = Layers.GetLayerZInterval(layer, false);
